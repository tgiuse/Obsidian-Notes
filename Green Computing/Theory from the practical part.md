...
1. **Multi-task learning** extends transfer learning principles by training single models to perform multiple related tasks simultaneously. These models feature shared early layers that process data in common ways, followed by task-specific layers that handle the unique requirements of each task. This architecture enables models to learn generalizable features useful across all tasks while maintaining specialized capabilities for specific applications.